...
model.fit([questions, contexts], [target_start, target_end, is_no_ans], epochs=5,
          validation_split=0.05, callbacks=callbacks_list, batch_size=128, verbose=1)
model.save('Models/model_aws.hdf5')
