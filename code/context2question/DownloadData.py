...
if __name__ == "__main__":
    ...
    model_small_id = '1TCSdKA0l0vWz2b80sH1es7SsKUyp09MW'
    model_small_destination = 'Models/model_small.hdf5'
    model_large_id = '1OoifCcB7UQcHiavcRRMwP9wlqJK0hhek'
    model_large_destination = 'Models/'
    ...
    download_file_from_google_drive(model_large_id, "Models/h.hdf5")
    print('Done.')
